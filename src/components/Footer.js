      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex space-x-4 pt-4">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110 hover:bg-gray-700"
                >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {["Help Center", "Documentation", "API Reference", "Community", "Status Page", "Bug Reports"].map(
                (link, index) => (
                  <li key={index}>
                    <a
                      href="/support"
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                  required
                />
              </div>
              <button
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="text-sm text-gray-400">© 2025 Solid. All rights reserved. Made with ❤️</div>
        </div>
      </div>
    </footer>
  );
      ...
      <div className="min-w-[150px] text-left">
        ...
        <ul className="space-y-2 text-gray-600">
          {["Home", "Product", "Careers", "Pricing"].map((item) => (
            <li key={item}>
              <a href={`/${item.toLowerCase()}`} className="hover:text-blue-600 transition-colors duration-200">
                {item}
              </a>
            </li>
          ))}
      ...
      <div className="min-w-[200px] text-left">
        ...
        <form className="flex" onSubmit={(e) => e.preventDefault()}>
          <input
            type="email"
            required
            className="flex-1 p-2 border rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
